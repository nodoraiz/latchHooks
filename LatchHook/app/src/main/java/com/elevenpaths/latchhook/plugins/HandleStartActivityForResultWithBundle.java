...
public class HandleStartActivityForResultWithBundle extends Plugin {

    @Override
    public String getPluginName() {
        return HandleStartActivityForResultWithBundle.class.getName();
    }
    ...
    public Method getMethodNameToHook(Class hookedClass) throws NoSuchMethodException {
        return hookedClass.getMethod("startActivityForResult ", Intent.class, int.class, Bundle.class);
    }
    ...
    public Object modifyAction(MS.MethodAlteration hookedMethod, Object capturedInstance, Object... args) throws Throwable {
        ...
        final int finalResponseCode = (int) args[1];
        final Bundle finalBundle = (Bundle) args[2];
            ...
            public void handleMessage(Message msg) {
                ...
                try {
                    if (!latchOpen) {
                        ...
                        finalMethod.invoke(finalContext, finalIntent, finalResponseCode, finalBundle);
                    }
                }catch (Throwable t){
                    t.printStackTrace();
                }
