...
public class HandleStartActivityForResultWithoutBundle extends Plugin {

    @Override
    public String getPluginName() {
        return HandleStartActivityForResultWithoutBundle.class.getName();
    }
    ...
    public Method getMethodNameToHook(Class hookedClass) throws NoSuchMethodException {
        return hookedClass.getMethod("startActivityForResult ", Intent.class, int.class);
    }
    ...
    public Object modifyAction(MS.MethodAlteration hookedMethod, Object capturedInstance, Object... args) throws Throwable {
        ...
        final int finalIntResponseCode = (int) args[1];
            ...
            public void handleMessage(Message msg) {
                ...
                try {
                    if (!latchOpen) {
                        ...
                        finalMethod.invoke(finalContext, finalIntent, finalIntResponseCode);
                    }
                }catch (Throwable t){
                    t.printStackTrace();
                }
